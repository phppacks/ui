<template>
  <div :class="`${prefixCls}-datepicker`">
    ...
    <transition name="fadeDown">
      <div :class="`${prefixCls}-datepicker-popup`" v-show ="displayDayView" v-ui-position="displayDayView">
...
export default {
  name: 'uiDatepicker',
  mixins: [inputMixin,localeMixin('uiDatepicker')],
  props: {
    value: {
      type: String
    },
  ...
  mounted () {
    var a = format.dateParse("1995-12-4",this.format);
