  ...
  <div :class="[prefixCls + '-upload']" ref="uploader">
    <div v-if="type === 'click'">
      <label>
        ...
        <slot>
          <ui-button>
            <ui-icon type="cloud-upload"></ui-icon>
            {{getL('click')}}
          </ui-button>
        </slot>
      </label>
      <div :class="[prefixCls + '-upload-list']" v-if="showList">
        <div :class="[prefixCls + '-upload-item']" v-for="(file, index) in uploadList">
          ...
          <ui-progress style="padding:0px 4px">
            <ui-progressbar
              type="success"
              height='3px'
              :now="progress[index]"
    ...
    <div v-if="type === 'drag'"
      ...
      <div 
        ...
        <ui-icon type="cloud-upload" :class="[prefixCls + '-upload-drag-icon']"></ui-icon>
